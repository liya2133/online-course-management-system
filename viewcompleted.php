        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <?php
                    $actions = array(
                       // 'delete' => array('label' => 'Completed', 'link' => 'completeitem.php', 'params' => array('id' => 'bid'), 'attributes' => array())
                    );
                    ...
                    $condition = " fid=$name  and c.status=4";

                    $join = array('course as dt'=>array('dt.coid=c.coid','join'),
                    'student as st'=>array('st.semail=c.semail','join')
                
                );

                    $fields = array('bid','c.coname','sname','c.cofee');
