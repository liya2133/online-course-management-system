...
if (!isset($_SESSION['semail'])) {
    ...
    $sql = "select sum(total) as t from joining where status=2";
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <?php
                    $actions = array(
                        'course completed' => array('label' => 'Completed', 'link' => 'completeitem.php', 'params' => array('id' => 'bid'), 'attributes' => array())
                    );
                    ...
                    $fields = array('bid', 'coid', 'coname','joindate');
