...
if (!isset($_SESSION['semail'])) {
    ...
    $sql = "select sum(total) as t from joining where status=1 and semail='$name'";
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <?php
                    $actions = array(
                        'delete' => array('label' => 'Delete', 'link' => 'deleteitem.php', 'params' => array('id' => 'bid'), 'attributes' => array())
                    );
                    ...
                    $condition = "semail='" . $name . "' and status=1";
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="col-md-9">
                    <div class="form-group">
                        <button class="btn btn-success" type="submit" name="purchase">New Course</button>
                        <button class="btn btn-primary" type="submit" style="margin-left: 10px;" name="payment">Payment</button>
                    </div>
                </div>
            </form>
        </div> <!-- End row -->
