...
if (!isset($_SESSION['semail'])) {
    ...
    $sql = "select sum(total) as t from joining where status=5 and semail='$name'";
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <?php
                    $actions = array(
                        'delete' => array('label' => 'Download', 'link' => 'certificate.php', 'params' => array('id' => 'bid'), 'attributes' => array())
                    );
                    ...
                    $condition = "semail='" . $name . "' and status=5";
